...
/**
 * Default mirror base URL. Same-origin: the SPA bundles the JSON under
 * `public/tax-data/v1/{year}.json` (generated by apps/web/scripts/build-tax-data.ts).
 * Override with `VITE_TAX_DATA_BASE_URL` to point at an external mirror.
 */
export const DEFAULT_TAX_DATA_BASE_URL = "/tax-data";
